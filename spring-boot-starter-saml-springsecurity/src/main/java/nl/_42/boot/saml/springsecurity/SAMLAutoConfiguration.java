package nl._42.boot.saml.springsecurity;

import lombok.AllArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import nl._42.boot.saml.springsecurity.config.SAMLConfigController;
import nl._42.boot.saml.key.KeystoreProperties;
import nl._42.boot.saml.springsecurity.user.SAMLUserService;
import nl._42.boot.saml.springsecurity.web.FriendlyURLComparator;
import nl._42.boot.saml.springsecurity.web.HttpLoggingPostBinding;
import nl._42.boot.saml.springsecurity.web.SAMLDefaultEntryPoint;
import nl._42.boot.saml.springsecurity.web.SAMLDiscoveryController;
import nl._42.boot.saml.springsecurity.web.SAMLFailureHandler;
import nl._42.boot.saml.springsecurity.web.SAMLFilter;
import nl._42.boot.saml.springsecurity.web.SAMLMetadataDisplayFilter;
import nl._42.boot.saml.springsecurity.web.SAMLMetadataGenerator;
import nl._42.boot.saml.springsecurity.web.SAMLSuccessRedirectHandler;
import nl._42.boot.saml.springsecurity.web.SAMLWebSSOProfile;
...
import static nl._42.boot.saml.springsecurity.SAMLProperties.throwIfBlank;
...
public class SAMLAutoConfiguration {
    ...
    public static class SAMLAuthenticationConfiguration {
        ...
        public KeyManager keyManager() {
            KeystoreProperties keystore = properties.getKeystore();
            Resource resource = keystore.getResource();
            if (resource == null) {
                return EMPTY;
            }

            Map<String, String> passwords = Collections.singletonMap(keystore.getUser(), keystore.getPassword());
            return new JKSKeyManager(resource, keystore.getPassword(), passwords, keystore.getKey());
        }
